...
- BaseAgent prompt 构造方法体系（persona / guidelines / tools / Skill management bootstrap / agents / knowledge）与每轮 Runtime Context 注入
- Bash-capable Agent 的 Skill-first / browser-last 能力选择策略
