...
| [system-prompt.md](core/system-prompt.md) | Sebastian 人设提示词、BASE_BUTLER_RULES + soul 文件热切换、BaseAgent 结构化 prompt 构造体系（persona/tools/skill management/agents/knowledge）、Bash-only Skill discovery bootstrap、per-agent 工具可见性 |
